...
class BulkProductImportRequest extends BaseRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'products.*.product_tires'                 => ['required', 'array'],
            'products.*.product_tires.*.from_quantity' => ['required', 'integer', 'min:1'],
            'products.*.product_tires.*.to_quantity'   => ['required', 'integer', 'min:1'],
            'products.*.product_tires.*.price'         => ['required', 'numeric', 'min:0'],
